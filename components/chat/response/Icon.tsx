...
export default function Icon(props: IconProps) {
  ...
  return (
    <Animated.View
      style={{ width: Device.deviceType !== 1 ? 52 : 40, aspectRatio: "4/4" }}
      entering={FadeIn.duration(300).easing(Easing.in(Easing.cubic))}
    >
      <Animated.View style={animatedStyles}>
        <Image source={require("../../../assets/img/wheel.png")} style={{ width: "100%", height: "100%" }} />
      </Animated.View>

      {Device.deviceType === 1 ? (
        <Svg width="40" height="40" viewBox="0 0 40 40" fill={theme.color.primary} style={{ position: "absolute" }}>
        ...
        <Svg width="52" height="52" viewBox="0 0 52 52" fill={theme.color.primary} style={{ position: "absolute" }}>
